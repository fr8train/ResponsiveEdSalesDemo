...
namespace {
    ...
    class Api extends \App\Library\Facades\ApiFacade{
        ...
        public static function get($command){
            return \App\Library\Dlap\Api::get($command);
        }
         ...
         * @static 
         */
        public static function post($payload, $command = null){
            return \App\Library\Dlap\Api::post($payload, $command);
        }
